...
def generate_benchmark_plots(df_res, num_rows):
    ...
    plt.tight_layout()
    output_img_path = f"workspace/images/benchmark_results_{num_rows}_rows.png"
...
def main(N_SAMPLES=None):
    ...
    DATA_PATH = os.path.join(os.path.abspath("workspace"), "data", "HIGGS.csv")
    ...
    if N_SAMPLES is not None:
        ...
        print("      Cargando todas las filas del dataset...")
    ...
    generate_benchmark_plots(df_res, df_pandas.shape[0])


if __name__ == "__main__":
    # main(N_SAMPLES=1_000_000)
    main()
